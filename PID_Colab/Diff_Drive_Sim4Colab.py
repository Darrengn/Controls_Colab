...
class Simulation():
    ...
    def __init__(self):
        ...
        planned_path = [
            ...
            [3.9, -3.9], [0.0, -3.9], [0.0, 3.9], [-3.9, 3.9],
...
class PathSimulator():
    def __init__(
        ...
        self.waypoints = {
            1: (0.0, -3.9, -pi/2, 1, 1),  2: (-3.9, -3.9, pi, 1, 1),
            3: (-3.9, 3.9, pi/2, 1, 1), 4: (3.9, 3.9, 0.0, 1, 1),
            5: (3.9, -3.9, -pi/2, 1, 1), 6: (0.0, -3.9, pi, 1, 1),
            7: (0.0, 3.9, pi/2, 1, 1), 8: (-3.9, 3.9, pi, -1, 1),
            9: (-3.9, -3.9, -pi/2, -1, 1), 10: (3.9, -3.9, 0.0, -1, 1),
            11: (3.9, 3.9, pi/2, -1, 1), 12: (0.0, 3.9, pi, -1, 1),
            13: (0.0, 0.0, -pi/2, -1, 1),
            # 1: (0.0, 3.9, pi/2, -1, 1), 2: (-3.9, 3.9, pi, -1, 1),
            # 3: (-3.9, -3.9, -pi/2, -1, 1), 4: (3.9, -3.9, 0.0, -1, 1),
            # 5: (3.9, 3.9, pi/2, -1, 1), 6: (0.0, 3.9, pi, -1, 1),
    ...
    def navigate(self, x, y, yaw):
        ...
        self.err_accum += err_lin
        print(self.err_accum)
        # print(np.rad2deg(theta_tar), np.rad2deg(yaw), np.rad2deg(err_ang))
        # print(xtar,ytar, err_lin)
        v = 2*err_lin + 0.001*self.err_accum #linear velocity
